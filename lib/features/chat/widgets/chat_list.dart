              ...
              return GestureDetector(
                onHorizontalDragUpdate: (details) {
                  if (details.delta.dx < 0) {
                    // Left swipe - reply to own message
                ...
                child: MyMessageCard(
                  ...
                  isSeen: messageData.isSeen, onLeftSwipe: (DragUpdateDetails details) {  },
                ),
              );
            } else {
              return GestureDetector(
                onHorizontalDragUpdate: (details) {
                  if (details.delta.dx > 0) {
                    // Right swipe - reply to sender's message
                ...
                child: SenderMessageCard(
                  ...
                  username: messageData.repliedTo,
                  repliedMessageType: messageData.repliedMessageType,
                  repliedText: messageData.repliedMessage, onRightSwipe: (DragUpdateDetails details) {  },
                ),
              );
            }
          },
